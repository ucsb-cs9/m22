---
title: "Syllabus, CMPSC 9, Summer 2022"
layout: handout
ready: true
---
...
* **Course Web Site**: <https://ucsb-cs9.github.io/m22/>
* **Instructor**: Richert Wang
   * Please use [Piazza](https://piazza.com/ucsb/summer2022/181c9) for course related communication.
* **Lecture**: Tu, W, Th 9:30am-10:50am, HSSB 1174
* **TAs**:  {{site.ta_list_full}} (contact via Piazza)
* **ULAs**: {{site.mentors_list}} (contact via Piazza)
* **Lab** (70 minute lab sections): Thursdays 11am (SSMS 1303), 12:30pm (PHELPS 1513), 2pm (PHELPS 1518)
* **Office Hours**: See <https://ucsb-cs9.github.io/m22/info/office_hours/>
...
|-----------------------------------------------|---------------------------|
| Quizzes (Fridays on Gradescope)               | 35 %                      |
| Final (Thursday 9/8), 9:30am - 10:50am        | 25 %                      |
| Homeworks                                     | 10 %                      |
| Labs                                          | 30 %                      |
